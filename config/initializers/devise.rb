...
Devise.setup do |config|
  ...
  # :none = No lock strategy. Default is :none.
  ...
  # is mountable, you can set `routed_helpers` to `true` or `false`. If true, it
  # will use the engine routes and helpers, otherwise it will use the main app
  # routes and helpers.
